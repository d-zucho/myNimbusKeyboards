...
const Scene = () => {
  ...
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      // add the initial dark to light transition
      gsap.to(
      ...
      // animate the keyboard into position on load
    ...
    <group>
      ...
      <group scale={scalingFactor}>
        <group ref={keyboardGroupRef}>
          <Keyboard scale={8} ref={keyboardAnimationRef} />
        </group>
        ...
        <group ref={keycapRef}>
          ...
          <Keycap
            ...
            texture={8}
          />
          <Keycap position={[2, 0, 1]} rotation={[0, 0, 3]} texture={6} />
        </group>
      </group>
